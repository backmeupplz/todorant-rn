...
export default {
  ...
  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#f9f9f9' : '#f9f9f9',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#343434' : '#343434',
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 56,
  toolbarSearchIconSize: platform === PLATFORM.IOS ? 20 : 23,
  toolbarInputColor: platform === PLATFORM.IOS ? '#f9f9f9' : '#f9f9f9',
  searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
  searchBarInputHeight: platform === PLATFORM.IOS ? 30 : 50,
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#f9f9f9' : '#f9f9f9',
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#f9f9f9' : '#f9f9f9',
  ...
  segmentActiveBackgroundColor:
    platform === PLATFORM.IOS ? '#f9f9f9' : '#f9f9f9',
  segmentTextColor: platform === PLATFORM.IOS ? '#f9f9f9' : '#f9f9f9',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#fff',
  segmentBorderColor: platform === PLATFORM.IOS ? '#f9f9f9' : '#f9f9f9',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#f9f9f9' : '#f9f9f9',
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#343434' : '#343434',
  ...
  subtitleColor: platform === PLATFORM.IOS ? '#f9f9f9' : '#f9f9f9',
  titleFontColor: platform === PLATFORM.IOS ? '#f9f9f9' : '#f9f9f9',
